function [hiddenWeights, outputWeights, error] = trainMomentumSGD(activationFunction, dActivationFunction, numberOfHiddenUnits, inputValues, targetValues, epochs, batchSize, learningRate)
...
% 
    ...
    % Momentum terms
    V_1 = zeros(numberOfHiddenUnits, inputDimensions);
    V_2 = zeros(outputDimensions, numberOfHiddenUnits);
    mu = 0.7;
    ...
    for t = 1: epochs
        for k = 1: batchSize
            ...
            % Updating the momentum term (V_2) and output weights
            V_2 = mu .* V_2 - learningRate.*outputDelta*hiddenOutputVector';
            outputWeights = outputWeights + V_2;
            
            % Updating the momentum term (V_1) and weights of the hidden layer 
            V_1 = mu .* V_1 - learningRate.*hiddenDelta*inputVector';
            hiddenWeights = hiddenWeights + V_1;
